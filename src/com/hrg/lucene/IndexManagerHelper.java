...
/**
 * 创建时间：创建时间：2018年4月27日 上午9:44:37 项目名称：voiceTest
 * 
 * @author lingxue
 * @version 1.0
 * @since JDK 1.8 
...
public class IndexManagerHelper {
	...
	public static Boolean findIndex() {
		...
		File file = new File(HOME_PATH + "/dataset/index/segments.gen");
		if (file.exists()) {
	...
	public static void build_index_test() throws IOException {
		...
		String dir =HOME_PATH + "dataset/WechatCBC.xls";
		try {
	...
	public static void main(String[] arg) {
		...
		String dir = "./dataset/precision_data/test_new_pred_to_find_similarity_result.xls";
		...
		try {
			...
			int cols = sheet.getColumns();
			System.out.println(rows + "," + cols);
			for (int z = 0; z < rows; z++) {// 0浠ｈ〃鍒楁暟锛寊浠ｈ〃琛屾暟
