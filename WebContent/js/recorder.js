(function(f) {
	...
	return (function e(t, n, r) {
		function s(o, u) {
			...
			//这两个if的作用说明了加载规则，
			//先是从缓存区域中找模块，如果没有就从未加载去找模块，如果两个地方都没有找到，
			//那么就判断是否存在自行构造的require，假如存在，尝试用自行构造的require加载模块，
			//如果加载还是失败，那么就判断外部环境中的require是否存在，如果还是没有，那么会报找不到模块错误。
			//在这个过程中，找到模块就会加载模块并将模块缓存到缓存区，供其他模块调用，当然里面有递归调用,
			//运行到 t[o][0].call，说明有模块在未加载区域，然后将function当作require传入，进行递归调用。
			return n[o].exports
		}
			...
			var Recorder = exports.Recorder = (function() {
				...
				default (function() {
						...
						function encodeWAV(samples) {
							...
							view.setUint32(4, 36 + samples.length * 2, true); /* RIFF type */
							...
							view.setUint16(32, numChannels * 2, true); /* bits per sample */
